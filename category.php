						...
						<div class="blog-box">
							...
							<div class="post-box-inner">
								<div class="box-content">
									...
									<span class="byline">
										<span class="author-image"><img src="<?=$editor_avatar;?>" alt="<?=$editor['nama_lengkap'];?>" class="img-circle" alt="<?=$post['title'];?>" width="30px" /></span>
									...
									<div class="post-content" id="post-content-<?=$post['id_post'];?>">
										...
										<a href="#"><img src="<?=$this->asset('/images/icon/comment-icon.png')?>" alt="<?=$post['title'];?>" /> <?=$this->post()->getCountComment($post['id_post']);?> <?=$this->e($front_comment);?></a>
									</div>
								</div>								
							</div>
						</div><!-- blog-box /- -->
